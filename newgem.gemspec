...
Gem::Specification.new do |s|
  ...
  s.description = <<-D
    Given a set of directories, this scripts outputs the files in them in a
    random order. Combined with limitations by size or by number, this can be
    used to pick a random collection of files from the given directories.
  D
